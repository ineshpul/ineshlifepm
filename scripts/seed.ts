...
import {
  saveArea, saveInitiative, saveGoal, saveCadenceRule, saveAssignee, saveMetric, getSettings, saveTask,
} from "../lib/repo";
import { SEED_AREAS } from "../lib/constants";
import type { Initiative, Goal, CadenceRule, Assignee, Metric, Task } from "../lib/types";
...
async function main() {
  ...
  console.log("Seeding starter tasks (inbox + active work)…");
  const starterTasks: Task[] = [
    {
      id: "task-leap-triage-bug",
      areaId: "leap-b2c",
      goalId: null,
      initiativeId: "init-leap-retention",
      type: "build",
      subtype: "bug",
      title: "Fix onboarding drop-off on step 2",
    ...
    {
      id: "task-leap-specced",
      areaId: "leap-b2c",
      goalId: null,
      initiativeId: "init-leap-retention",
      type: "build",
      subtype: "feature",
      title: "Ship weekly retention email variant B",
      definitionOfDone: "A/B live in production",
      size: "M",
      estimateMinutes: null,
      actualMinutes: null,
      priority: 3,
      ...
      closedAt: null,
      lastTouchedAt: now,
      hypothesis: "Re-engage D7 users",
      targetMetric: "metric-d7-retention",
      artifactDefinition: null,
      cadenceRuleId: null,
      committedForDate: null,
      droppedReason: null,
    ...
    {
      id: "task-b2b-pipeline",
      areaId: "leap-b2b",
      goalId: null,
      initiativeId: "init-b2b-pipeline",
      type: "build",
      subtype: "issue",
      title: "Update pilot agreement template",
      definitionOfDone: "Legal-reviewed doc in drive",
      size: "S",
      estimateMinutes: null,
      actualMinutes: null,
      priority: 3,
    ...
    },
    {
      ...
      areaId: "pm-recruiting",
      goalId: null,
      initiativeId: "init-pm-applications",
      type: "assignment",
      subtype: null,
      title: "Tailor resume for Stripe PM role",
      definitionOfDone: null,
      size: "M",
      estimateMinutes: null,
      actualMinutes: null,
    ...
    {
      id: "task-school-assignment",
      areaId: "school",
      goalId: null,
      initiativeId: null,
      type: "assignment",
      subtype: null,
      title: "Submit Fin 402 problem set 4",
      definitionOfDone: null,
      size: "L",
      estimateMinutes: null,
      actualMinutes: null,
    ...
    {
      id: "task-delegated-uiuc",
      areaId: "campus",
      goalId: null,
      initiativeId: "init-uiuc-handoff",
      type: "delegated",
      subtype: null,
      title: "Ronin: run first solo IU outreach call",
      definitionOfDone: "Call completed without you on the line",
      size: null,
      estimateMinutes: null,
      actualMinutes: null,
      priority: 3,
  ...
  for (const t of starterTasks) await saveTask(t);
