...
export function FeedPostEngagement({
  ...
  React.useEffect(() => {
    ...
    const onShow = (e: KeyboardEvent) => animateInset(e.endCoordinates.height, e.duration ?? 250);
    const onHide = (e: KeyboardEvent) => animateInset(0, e.duration ?? 250);
