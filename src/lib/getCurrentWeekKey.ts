/**
 * Canonical leap-week key (single source of truth for app + Cloud Functions).
 * Keep in sync with `functions/src/getCurrentWeekKey.ts`.
 *
...
export const msUntilNextNySundayWeekStart = msUntilNextWeekReset;
